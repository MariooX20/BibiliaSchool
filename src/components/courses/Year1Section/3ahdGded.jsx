...
function Year1NewTestament({ setActiveTab }) {
  // Placeholder data for lessons
  const lessons = [
    { id: 1, title: "مقدمة في العهد الجديد", duration: "40 دقيقة", type: "فيديو" },
    { id: 2, title: "إنجيل متى - الجزء الأول", duration: "55 دقيقة", type: "فيديو" },
    { id: 3, title: "اختبار على إنجيل متى", duration: "20 دقيقة", type: "امتحان" },
  ];
